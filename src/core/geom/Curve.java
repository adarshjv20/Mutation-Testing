...
public final class Curve extends Shapes {
    ...
    public void checktolerator(int x){
        int checktol=x;
        try {
            String op=System.lineSeparator()+System.lineSeparator()+"Package Name: package core.geom Class: Curve Inside function checktolerator: checktol declared at line 35"+System.lineSeparator();
            outFile.write(op);
            outFile.flush();
        }
        ...
        checktol+=4;
        try {
            String op="Package Name: package core.geom Class: Curve Inside function checktolerator calculate checktol with checktol+=4"+System.lineSeparator();
            outFile.write(op);
            outFile.flush();
        }
        catch (java.io.IOException er) {er.printStackTrace();}
        ...
        ;
        try {
            String op="Package Name: package core.geom Class: Curve Inside function checktolerator resultant checktol: "+ checktol +System.lineSeparator();
            outFile.write(op);
            outFile.flush();
        }
        catch (java.io.IOException er) {er.printStackTrace();}
