...
public class Line extends Shapes {
    ...
    public void Resize(int x1, int y1, int x2, int y2) {
        try {
            String op=System.lineSeparator()+System.lineSeparator()+"Package Name: package core.geom Class: Line "+"Inside function Resize at line 71 if condition with expr x2 < x1"+System.lineSeparator();
            outFile.write(op);
            outFile.flush();
        }
        ...
        if(x2 < x1) {
            ...
            try {
                ...
                String op="Package Name: package core.geom Class: Line "+"at line 85 if block executed. slope= "+slope+System.lineSeparator();
                outFile.write(op);
                outFile.flush();
            }catch (java.io.IOException er) {er.printStackTrace();}
        ...
        else
        {
            ...
            try {
                ...
                String op="Package Name: package core.geom Class: Line "+"at line 97 else block executed. slope= "+slope+System.lineSeparator();
                outFile.write(op);
                outFile.flush();
            }catch (java.io.IOException er) {er.printStackTrace();}
