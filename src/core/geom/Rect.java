...
public class Rect extends Shapes {
    ...
    public void RectReAllign() {
        try {

            String op = "Package Name: package core.geom Class: Rect " + "Inside function RectReAllign at line 221 print Stmnt" + System.lineSeparator();
            outFile.write(op);
            outFile.flush();
        } catch (java.io.IOException er) {
            er.printStackTrace();
        }
        System.out.println("Test for SDL");
    }
